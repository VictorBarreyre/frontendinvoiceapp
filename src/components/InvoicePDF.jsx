...
import { Text, View, Document, StyleSheet, Page, Font, } from '@react-pdf/renderer';
...
const styles = StyleSheet.create({
  ...
  issuerDetails: {
    display: 'flex',
    flexDirection: 'column',
    width: '50%', // Assurez-vous que chaque enfant prend seulement la moitié de l'espace
    paddingLeft: 40,
  },
  ...
  totalDetails: {
    display: 'flex',
    flexDirection: 'column',
    width: '100%', // Assurez-vous que chaque enfant prend seulement la moitié de l'espace
    alignItems: 'end',
    ...
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.paiementDetails}>
          ...
          <Text style={styles.text}>
            IBAN sur lequel le paiement sera envoyé
          </Text>
          <Text style={styles.text}>
